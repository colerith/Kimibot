...
IDS = {
    ...
    "VERIFICATION_ROLE_ID": 1417722528574738513, # 新兵蛋子
    "HATCHED_ROLE_ID": 1417722389718110249,       # 正式/全区权限身份
    "TICKET_PANEL_CHANNEL_ID": 1417572579304013885, # 工单面板（申请全区）
    "QUIZ_CHANNEL_ID": 1467034060026286090,         # 新增：答题频道（申请新兵）
    "FIRST_REVIEW_CHANNEL_ID": 1418598526765629550, 
    "SECOND_REVIEW_CHANNEL_ID": 1419599094988537856, # 虽然取消了流程，ID先留着防报错或做归档区
