...
IDS = {
    ...
    "PHONE_WISH_CHANNEL_ID": 1551635639320182954,
...
SUBMISSIONS = {
    ...
    "COMMENT_REWARD_RANGE": (1.0, 5.0),
    "COMMENT_DAILY_CAP": 15.0,
    "DELETE_PENALTY_RATE": 0.5,
    "MIN_CONTENT_LENGTH": 15,
    "MEANINGLESS_WARNING_THRESHOLD": 3,
    "MANUAL_REPLY_REWARD_MAX": 100.0,
}
